...
class ImageManipulation:
    ...
    @classmethod
    def create_image_card_wh(cls,text_field:str, image_link:str, width: int, height: int, invert:bool = False, text_lower: bool=False, text_size: int = 25, sub_text: bool = False, sub_text_field: str = ''):
        '''
        ...
        if sub_text:
            bg = cls.draw_text_with_halo(bg, (35,bg.size[1]- title.getsize(text_field)[1]+10), sub_text_field, text, 'lt', (255,255,255), color )
